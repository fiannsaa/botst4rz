...
//
const BotName = 'FIANNSAA BOT 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/bintang_nur_pradana'; // Nama Instagramlu cok
const whatsapplu = '0856-5688-4416'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/Grvc9b7LCXEA3J2ehlN438'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/Kv7GPoF6jvuLF5GO0hgQXm'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
